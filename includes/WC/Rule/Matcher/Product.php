...
use OneTeamSoftware\WC\Rule\Matcher\ItemOptionMatcher\Product as ItemOptionMatcherProduct;

class Product extends ItemsMatcher
{
	/**
	 * constructor
	 *
	...
	public function __construct(LoggerInterface $logger = null)
	{
		parent::__construct(
			get_class($this),
			new ItemMatcher(
				new ItemOptionMatcherProduct($logger)
			),
			$logger
		);
	}
